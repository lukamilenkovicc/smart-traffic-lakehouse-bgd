...
OUTPUT_DIR_FLOW = "/Volumes/bg_traffic/bg_traffic_bronze/landing/tomtom/flow"
OUTPUT_DIR_INCIDENT = "/Volumes/bg_traffic/bg_traffic_bronze/landing/tomtom/incidents"
...
def fetch_tomtom():
    ...
    os.makedirs(OUTPUT_DIR_INCIDENT, exist_ok=True)
    ...
    try:
        ...
        flow_filepath = f"{OUTPUT_DIR_FLOW}/tomtom_flow_{timestamp_str}.json"
        ...
        inc_filepath = f"{OUTPUT_DIR_INCIDENT}/tomtom_incidents_{timestamp_str}.json"
